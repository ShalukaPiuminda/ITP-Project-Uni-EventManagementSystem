...
function TermsAndConditions() {
  return (
    <div>
      ...
      <p>The term 'us' or 'we' refers to the owner of the website whose registered office is 123 Main Street, City, Country. The term 'you' refers to the user or viewer of our website.</p>
