                ...
                >
                  ...
                  {reservation.status === "waiting for the approval" && userid == reservation.userId  ? (
                    <div className="w-1/2 h-1/2 mx-14 mt-14 flex justify-center">
                      ...
                      <button
                        type="submit"
                        className="mx-4 text-white bg-red-700 hover:bg-red-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
                      >
